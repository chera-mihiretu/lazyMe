          ...
          <div className="relative">
            ...
            >
              ...
              >
                ...
                >
                  Account
                  <span className="bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent"> Verified!</span>
                </motion.h1>
                ...
                >
                  Congratulations! Your email has been successfully verified. You can now access all features of IKnow.
                </motion.p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-400 text-xs">
                  You will be automatically redirected to the login page to start your journey.
                </p>
              </motion.div>
              ...
              >
                <h4 className="text-white font-semibold mb-4">You now have access to:</h4>
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-3xl blur-3xl transform rotate-3 scale-110 -z-10"></div>
          </div>
        </div>
      </div>
