...
function ResetPasswordContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden relative">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-6">
        <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              {[
                "Password encrypted with industry standards",
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-14 py-4 bg-white/5 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50 transition-all duration-300"
                      required
                      disabled={loading}
                    />
                    <motion.button
                  ...
                  {password && (
                    ...
                    >
                      ...
                      <p className="text-xs text-gray-400">
                        ...
                        {password.length >= 6 && password.length < 8 && "Good"}
                ...
                <motion.button
                  ...
                  whileHover={{ scale: loading || !password ? 1 : 1.02, y: loading || !password ? 0 : -2 }}
                  whileTap={{ scale: loading || !password ? 1 : 0.98 }}
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
      ...
      >
        © 2025 IKnow. Secure password management for your campus journey.
      </motion.footer>
    </div>
  );
}
