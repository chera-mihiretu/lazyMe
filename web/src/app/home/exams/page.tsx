        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-6">
              <motion.div
                className="w-12 h-12 rounded-2xl bg-gradient-to-br from-indigo-500 to-indigo-600 p-3 shadow-lg"
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Past Exams</h1>
                <p className="text-gray-600 mt-1">Access past exams, practice questions, and exam resources</p>
              </div>
              <motion.div
                className="ml-auto inline-flex items-center px-3 py-1.5 rounded-full bg-indigo-100 border border-indigo-200 text-indigo-700 text-sm font-medium"
