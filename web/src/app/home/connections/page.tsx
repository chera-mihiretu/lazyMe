        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-6">
              <motion.div
                className="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-500 to-emerald-600 p-3 shadow-lg"
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
              ...
              <motion.div
                className="ml-auto inline-flex items-center px-3 py-1.5 rounded-full bg-emerald-100 border border-emerald-200 text-emerald-700 text-sm font-medium"
          ...
          >
            {loading ? (
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6">
                ...
                >
                  <motion.div
                    className="w-10 h-10 bg-gradient-to-br from-emerald-500 to-blue-600 rounded-xl flex items-center justify-center shadow-md"
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm mt-0.5">{requests.length} people want to connect with you</p>
                  </div>
                </motion.div>
                ...
                <div className="space-y-4">
                  <AnimatePresence>
                    {requests.map((user, index) => (
                      <motion.div
                        key={user.id}
                        className="flex items-center justify-between bg-white/60 backdrop-blur-sm border border-gray-200/50 rounded-xl p-4 hover:bg-white/80 hover:shadow-md transition-all duration-300"
                    ...
                    <Image
                      ...
                      alt={user.name}
                              width={48}
                              height={48}
                              className="rounded-full object-cover border-2 border-emerald-200/50 shadow-sm"
                            />
                            <motion.div
                              className="absolute -top-1 -right-1 w-4 h-4 bg-gradient-to-br from-emerald-400 to-blue-500 rounded-full border-2 border-white"
                    ...
                    disabled={accepting === user.id}
                          className={`inline-flex items-center gap-2 px-6 py-2.5 rounded-xl font-semibold text-sm transition-all duration-300 shadow-md hover:shadow-lg ${
                            accepting === user.id
