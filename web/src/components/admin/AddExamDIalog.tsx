...
const AddExamDialog: React.FC<AddExamDialogProps> = ({ open, onClose }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(errData.message || "Failed to add exam");
      }
      setExamTitle("");
      ...
      setAddError("Error adding exam: " + err);
    } finally {
      setAddLoading(false);
    }
  };
          ...
          >
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Upload a new exam</p>
                </div>
              </div>
              <motion.button
                onClick={onClose}
            ...
            <div className="flex gap-3 mt-6">
              ...
              <motion.button
                ...
                disabled={!selectedUniversity || !selectedSchool || !selectedDepartment || !examTitle.trim() || !examFile || addLoading}
                whileHover={{ scale: (!selectedUniversity || !selectedSchool || !selectedDepartment || !examTitle.trim() || !examFile || addLoading) ? 1 : 1.02 }}
                whileTap={{ scale: (!selectedUniversity || !selectedSchool || !selectedDepartment || !examTitle.trim() || !examFile || addLoading) ? 1 : 0.98 }}
              >
                {addLoading ? (
                  <>
