...
import { BookOpen, Edit, Trash2, AlertTriangle, Loader2, Info, Calendar, ChevronRight } from 'lucide-react';
  ...
  return (
    <>
      ...
      >
        ...
        {loading ? (
          ...
          >
            {departments.slice(0, 4).map((department, index) => (
              <motion.div
                key={department.id}
                className="group bg-gray-50 rounded-xl p-4 border border-gray-100 hover:border-indigo-200 hover:bg-indigo-50/30 transition-all duration-300"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 mt-2">
                      ...
                      {department.year !== undefined && (
                        <div className="flex items-center text-sm text-gray-500">
                          <Calendar className="w-3 h-3 mr-1 flex-shrink-0" />
                          <span>Year {department.year}</span>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2 ml-4">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      onClick={() => { 
                        setShowDeleteDialog(department.id); 
                        setDeleteInput(""); 
                        setDeleteError(""); 
                      }}
                    >
        ...
        {/* More Button */}
        <motion.button
          className="w-full mt-6 px-4 py-3 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group"
            ...
            >
              ...
              <div className="mb-4">
                <p className="text-gray-700 mb-3">
                  Type <span className="font-semibold text-red-600">&quot;delete department&quot;</span> to confirm deletion.
                </p>
                <input
                  type="text"
                  value={deleteInput}
